    ...
    try:
        ...
        if not db.query(Transaction).filter(Transaction.id == "TRX001").first():
            trx1 = Transaction(
                ...
                cost_center_name="Comercial & Vendas",
                amount=500.0,
                net_amount=406.50,
                vat_rate=23,
                vat_amount=93.50,
                ...
                ai_confidence=96,
                document_id="DOC001",
                document_name="google_ads_aug_2026.pdf",
                document_number="FT 2026/00452",
                document_type="invoice",
                document_date="2026-08-25",
                is_recurring=True,
                recurrence_period="monthly",
                payment_method="Cartão Empresarial",
                notes="Campanha de aquisição de clientes Q3 2026",
                tags="Q3-2026,Aquisição,Google",
                created_by="Motor IA",
                approved_by="João Silva",
                approved_at="2026-08-28T11:00:00Z",
            )
            trx2 = Transaction(
                id="TRX002",
                company_id="COMP001",
